            ...
            <Stack direction="column" spacing={2} sx={{ width: '100%', maxHeight: '75vh' }}>
                ...
                <Stack direction="row" sx={{ justifyContent: "space-between", alignItems: "center", }}>
                    <Stack direction="column" spacing={1}>
                        ...
                        <Typography variant="body1">
                            Create the architecture for the platform with an emphasis on componentization to reduce dependencies, increase modularity, and provide faster development time.
                            <ul>
                                <li></li>
                                <li></li>
                            </ul>
                        ...
                        <Typography variant="body1">
                            Create and deploy system image builds for emulator, Raspberry Pi, and tablet development.
                            <ul>
                                <li></li>
                                <li></li>
                            </ul>
