...
export default function Projects() {
    ...
    function body() {
        switch(activeModal) {
            case 'None':
                return <ProjectsListMobile onClick={setActiveModal}/>;
            case 'Flightcase':
                return (
                    <ProjectItemMobile projectTitle="Flightcase" images={flightcaseImages} onClose={setActiveModal}>
            ...
            case 'Arduino CAN BUS':
                return (
                    <ProjectItemMobile projectTitle="Arduino CAN BUS" images={arduinoCANImages} onClose={setActiveModal}>
                        <Typography variant="body1">
            ...
            case 'MEngine92':
                return (
                    <ProjectItemMobile projectTitle="MEngine92" images={mEngine92Images} onClose={setActiveModal}>
                        <Typography variant="body1">
            ...
            case 'Fisker':
                return (
                    <ProjectItemMobile projectTitle="Fisker Ocean" images={fiskerOceanImages} onClose={setActiveModal}>
                        <Typography variant="body1">
            ...
            case 'Companion Species':
                return (
                    <ProjectItemMobile projectTitle="Companion Species" images={companionSpeciesImages} onClose={setActiveModal}>
                        <Typography variant="body1">
            ...
            case 'Virtual Lab Template':
                return (
                    <ProjectItemMobile projectTitle="ATI Virtual Lab Template" images={virtualLabImages} onClose={setActiveModal}>
                        <Typography variant="body1">
            ...
            case 'Project Ambrosia':
                return (
                    <ProjectItemMobile projectTitle="ATI Project Ambrosia" images={ambrosiaImages} onClose={setActiveModal}>
                        <Typography variant="body1">
